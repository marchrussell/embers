              ...
              <div className="border-t border-muted-foreground/20 py-10 md:py-14">
                ...
                <div className="space-y-4 text-base leading-relaxed text-foreground/90 md:space-y-5 md:text-lg">
                  <p>
                    ...
                    improve sleep, boost energy, or access deeper states of awareness, we've curated
                    a collection of guided sessions to support your journey.
                  </p>
                  <p>
              ...
              <div className="border-t border-muted-foreground/20 py-10 md:py-14">
                ...
                <div className="space-y-4 text-base leading-relaxed text-foreground/90 md:space-y-5 md:text-lg">
                  <p>
                    ...
                    We're all unique, with different nervous systems, health histories, and needs —
                    so please take things at your own pace.
                  </p>
                  <p>
                    Before diving in, read through the session descriptions carefully and
                    familiarize yourself with the Safety Disclosure below. If you're unsure whether
                    breathwork is right for you, please reach out to your doctor or healthcare
                    provider.
                  </p>
                  <p>
                    And of course, I'm always here if you want to drop me a message with any
                    questions or concerns. Your safety and wellbeing come first.
                  </p>
                  <p className="pt-2">
