        ...
        <Card className="rounded-2xl border border-white/10 bg-black/30 p-8 backdrop-blur-md md:p-12">
          ...
          >
            ...
            <section className="space-y-4">
              ...
              <h3 className="mt-4 text-lg font-medium text-[#E6DBC7]">
            ...
            <section className="space-y-4">
              ...
              <p>
                ...
                App (favourites, progress, breathing habits) are optional and processed under your
                consent.
              </p>
              <p className="text-[#E6DBC7]">
                Do not upload medical records, diagnostic information, or sensitive biometric data.
              </p>
            </section>
            ...
            <section className="space-y-4">
              ...
              <p>
                You may delete your entire account, which permanently erases chat history and
                personal data except legally required records.
              </p>
            </section>
            ...
            <section className="space-y-4">
              ...
              <p>
                You may disable non-essential cookies at any time through your browser settings or
                cookie banner.
              </p>
              <p>
            ...
            <section className="space-y-4">
              ...
              <p>
                ...
                collect personal data from anyone under 16. If you believe we have unintentionally
                collected such data, contact us for immediate deletion.
              </p>
            </section>
            ...
            <section className="space-y-4">
              ...
              <p>
                We do not collect sensitive data unless you voluntarily disclose wellbeing
                considerations for safety purposes.
              </p>
              <p>
                Event data is retained only as long as needed for event administration and
                compliance.
              </p>
            </section>
            ...
            <section className="space-y-4">
              ...
              <p>
                For material changes (e.g., new AI processing), we will notify you via email or
                in-app.
              </p>
            </section>
