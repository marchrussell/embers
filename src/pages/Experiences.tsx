...
// Inner component — contains useSuspenseQuery so the Suspense boundary in
// the outer Experiences component can actually catch its suspension.
      ...
      <main className="flex-1">
        ...
        <section className="px-6 pb-40 md:px-10 md:pb-56 lg:px-12 lg:pb-72">
                ...
                return (
                  <FadeUp key={event.id} delay={index * 80}>
                    ...
                    >
                      ...
                      <div className="mt-8 hidden justify-start md:flex lg:ml-auto lg:mr-8 lg:mt-10">
                        <button
                          onClick={(e) => {
                            e.stopPropagation();
                            handleBookEvent(event);
          ...
          <div className="mx-auto max-w-[1600px] space-y-20">
            ...
            {/* The Studio Hom Card - Horizontal Layout */}
            <FadeUp delay={100}>
              <div
