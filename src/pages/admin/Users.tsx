...
const AdminUsers = () => {
  ...
  const fetchUsers = async () => {
    try {
      ...
      const usersData: UserData[] = profiles.map((profile) => {
        ...
        const userRoles =
          roles?.filter((role) => role.user_id === profile.id).map((r) => r.role) || [];
  ...
  if (isLoading) {
    return (
      <AdminLayout title="App Users & Analytics" description="Manage users and track key metrics">
  ...
  return (
    <AdminLayout title="App Users & Analytics" description="Manage users and track key metrics">
      <Tabs defaultValue="analytics" className="w-full">
        <TabsList className="mb-8 grid w-full max-w-md grid-cols-2 border border-white/10 bg-white/5">
          <TabsTrigger
            value="analytics"
            ...
            <>
              ...
              <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
                <Card className="border-[#E6DBC7]/20 bg-background/40 backdrop-blur-xl">
                  <CardContent className="pt-6">
                    ...
                    <div className="mt-1 text-xs text-foreground/60">All-time total</div>
                  </CardContent>
                </Card>
              ...
              <Card className="border-[#E6DBC7]/20 bg-background/40 backdrop-blur-xl">
                <CardHeader>
                  ...
                  <p className="mt-1 text-sm text-foreground/60">When users are most active</p>
                </CardHeader>
                <CardContent>
                  <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                    <div>
                      <h4 className="mb-3 text-sm font-medium text-[#E6DBC7]">Top Hours</h4>
                      <div className="space-y-2">
                        {analytics.peakUsageHours.map((hourData, index) => (
                          <div
                            key={index}
                            className="flex items-center justify-between rounded border border-[#E6DBC7]/10 p-2"
                          >
                    ...
                    <div>
                      <h4 className="mb-3 text-sm font-medium text-[#E6DBC7]">By Day of Week</h4>
                      <div className="space-y-2">
              ...
              <Card className="border-[#E6DBC7]/20 bg-background/40 backdrop-blur-xl">
                ...
                <CardContent>
                  <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
                    <div className="rounded-lg border border-[#E6DBC7]/10 p-4 text-center">
                      <div className="mb-1 text-3xl font-light text-[#E6DBC7]">
              ...
              <Card className="border-[#E6DBC7]/20 bg-background/40 backdrop-blur-xl">
                <CardHeader>
                  ...
                  <p className="mt-1 text-sm text-foreground/60">Users with session activity</p>
                </CardHeader>
                <CardContent>
                  <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
                    <div className="rounded-lg border border-[#E6DBC7]/10 p-4 text-center">
              ...
              <Card className="border-[#E6DBC7]/20 bg-background/40 backdrop-blur-xl">
                ...
                <CardContent>
                  <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
                    <div className="rounded-lg border border-[#E6DBC7]/10 p-4 text-center">
                      <div className="mb-1 text-2xl font-light text-[#E6DBC7]">
              ...
              <Card className="border-[#E6DBC7]/20 bg-background/40 backdrop-blur-xl">
                <CardHeader>
                  ...
                  <p className="mt-1 text-sm text-foreground/60">Total plays by category</p>
                </CardHeader>
                <CardContent>
                  <div className="space-y-3">
                    {analytics.categoryPerformance.map((cat, index) => (
                      <div
                        key={index}
                        className="flex items-center justify-between rounded-lg border border-[#E6DBC7]/10 p-3"
                      >
                        <div className="font-medium text-foreground/90">{cat.category}</div>
                        <div className="text-right">
                          <div className="text-lg font-light text-[#E6DBC7]">{cat.plays}</div>
                    ...
                    {analytics.programCompletionRates.map((program, index) => (
                      ...
                      >
                        <div>
                          ...
                          <div className="mt-1 text-xs text-foreground/60">
                            {program.totalEnrollments} user
                            {program.totalEnrollments !== 1 ? "s" : ""} enrolled
                          </div>
                        </div>
                        <div className="text-right">
                          <div className="text-2xl font-light text-[#E6DBC7]">
                      ...
                      .map((session, index) => (
                        ...
                        >
                          <div className="flex items-center gap-3">
                            <div className="min-w-[40px] text-lg font-light text-[#E6DBC7]">
                              #{index + 1}
                            </div>
                            <div>
                              <div className="font-medium text-foreground/90">{session.title}</div>
                            </div>
                          </div>
                          <div className="flex items-center gap-6">
                            <div className="text-right">
                              ...
                              <div className="text-xs text-foreground/60">plays</div>
                            </div>
                            <div className="text-right">
                              <div className="text-lg font-light text-[#E6DBC7]">
                                {session.favorites}
        ...
        <TabsContent value="users" className="space-y-6">
          {/* Search & Filters */}
          <Card className="border-[#E6DBC7]/20 bg-background/40 p-6 backdrop-blur-xl">
            <div className="flex flex-col items-start justify-between gap-4 lg:flex-row lg:items-center">
              {/* Search Input */}
              <div className="relative w-full max-w-md flex-1">
                <Search className="absolute left-4 top-1/2 h-5 w-5 -translate-y-1/2 transform text-[#E6DBC7]/60" />
                <Input
                  placeholder="Search by name or email..."
                  value={searchQuery}
                  onChange={(e) => setSearchQuery(e.target.value)}
                  className="h-12 border-[#E6DBC7]/30 bg-background/60 pl-12 text-foreground placeholder:text-foreground/50 focus:border-[#E6DBC7]/60"
                />
                {searchQuery && (
                  <button
                    onClick={() => setSearchQuery("")}
                    className="absolute right-4 top-1/2 -translate-y-1/2 transform text-foreground/50 transition-colors hover:text-foreground/80"
                  >
              ...
              <div className="flex items-center gap-6 text-sm">
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-medium text-[#E6DBC7]">
                    {
                      filteredUsers.filter(
                        (u) => u.subscription_status === "active" || u.roles.length > 0
                      ).length
                    }
                  </span>
                </div>
                <div className="flex items-center gap-2">
                  <div className="h-2 w-2 rounded-full bg-[#E6DBC7]/40" />
            ...
            {searchQuery && (
              <div className="mt-4 border-t border-[#E6DBC7]/10 pt-4">
                <p className="text-sm text-foreground/60">
                  Found <span className="font-medium text-[#E6DBC7]">{filteredUsers.length}</span>{" "}
          ...
          <Tabs defaultValue="active" className="w-full">
            <TabsList className="mb-6 grid w-full max-w-md grid-cols-2 border border-white/10 bg-white/5">
              <TabsTrigger
                value="active"
                className="text-white/70 data-[state=active]:bg-white/10 data-[state=active]:text-white"
              >
            ...
            <TabsContent value="active" className="space-y-6">
                  ...
                  .map((user) => (
                    ...
                    >
                      <CardHeader>
                        <div className="flex items-start justify-between">
                          <div className="flex items-center gap-3">
                            <div className="flex h-10 w-10 items-center justify-center rounded-full bg-[#E6DBC7]/10">
                              <User className="h-5 w-5 text-[#E6DBC7]" />
                            </div>
                            <div>
                          ...
                          <div className="flex flex-wrap items-center gap-2">
                            ...
                            {user.subscription_status === "active" && (
                              <Badge className="border-green-500/30 bg-green-500/20 capitalize text-green-300">
                                💳{" "}
                            ...
                            <Button
                              ...
                              className="ml-2 h-10 w-10 p-0 text-destructive hover:bg-red-500/10 hover:text-destructive"
                              title="Delete user"
                            >
                      ...
                      <CardContent>
                        <div className="mb-6 grid grid-cols-2 gap-4 text-sm md:grid-cols-4">
                          <div>
                            <p className="mb-1 text-foreground/50">Joined</p>
                            <p className="text-foreground/90">
                              {new Date(user.created_at).toLocaleDateString()}
                            </p>
                          </div>
                          <div>
                            <p className="mb-1 text-foreground/50">Onboarding</p>
                            <div className="flex items-center gap-1">
                              {user.has_completed_onboarding ? (
                                ...
                                <>
                                  <XCircle className="h-4 w-4 text-foreground/50" />
                          ...
                          <div>
                            <p className="mb-1 text-foreground/50">Safety Disclosure</p>
                            <div className="flex items-center gap-1">
                          ...
                          {user.subscription_end && (
                            <div>
                              <p className="mb-1 text-foreground/50">Subscription End</p>
                              <p className="text-foreground/90">
              ...
              {filteredUsers.filter((u) => u.subscription_status === "active" || u.roles.length > 0)
                .length === 0 && (
                <Card className="border-[#E6DBC7]/20 bg-background/40 backdrop-blur-xl">
              ...
              <div className="grid gap-4">
                {filteredUsers
                  ...
                  .map((user) => (
                    <Card
                      key={user.id}
                      className="border-[#E6DBC7]/20 bg-background/40 opacity-70 backdrop-blur-xl transition-all hover:border-[#E6DBC7]/40"
                    >
                      <CardHeader>
                        <div className="flex items-start justify-between">
                          <div className="flex items-center gap-3">
                      ...
                      <CardContent>
                        <div className="grid grid-cols-2 gap-4 text-sm md:grid-cols-4">
                          ...
                          {user.subscription_end && (
                            <div>
                              <p className="mb-1 text-foreground/50">Subscription Ended</p>
                              <p className="text-foreground/90">
                                {new Date(user.subscription_end).toLocaleDateString()}
                              </p>
                            </div>
                ...
                <Card className="border-[#E6DBC7]/20 bg-background/40 backdrop-blur-xl">
                  <CardContent className="py-12 text-center">
                    ...
                    <p className="mt-2 text-xs text-foreground/50">
                      Only users who previously had paid subscriptions appear here
                    </p>
                  </CardContent>
                </Card>
              )}
        ...
        <AlertDialogContent className="border-[#E6DBC7]/20 bg-background">
          <AlertDialogHeader>
            ...
            <AlertDialogDescription className="text-white/60">
              ...
              {selectedUser?.full_name || selectedUser?.email}? This will cancel their Stripe
              subscription and permanently remove all user data including progress and favorites.
