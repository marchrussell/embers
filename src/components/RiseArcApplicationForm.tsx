...
const SelectionOption = ({
  ...
  <button
    ...
    onClick={onSelect}
    className={cn(
      "flex min-h-[52px] w-full items-center gap-4 rounded-xl px-5 py-4 text-left transition-colors duration-200",
      "border",
      selected
  ...
  >
    ...
    <div
      className={cn(
        "flex h-6 w-6 flex-shrink-0 items-center justify-center transition-colors duration-200",
    ...
    <span
      className={cn(
        ...
        selected ? "font-normal text-white" : "text-white/80",
        italic && "italic"
      )}
    >
      {label}
...
export const RiseArcApplicationForm = ({ open, onOpenChange }: RiseArcApplicationFormProps) => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const { error } = await supabase.from("arc_applications").insert({
    ...
    switch (step) {
        ...
        return (
          <div className="space-y-8">
            ...
            <div className="mb-8 border-b border-white/[0.08] pb-8">
              <h3 className="mb-5 text-xl font-light text-white md:text-2xl">Before You Apply</h3>
              <div className="max-w-[55ch] space-y-4 text-[15px] leading-[1.75] text-white/70 md:text-base">
                <p>This isn't a test — just a gentle check-in to understand where you are.</p>
                <p>Take your time. There are no right answers, just honesty in your own words.</p>
              </div>
            </div>

            <div className="space-y-6">
              <div>
                <h3 className="mb-2 text-lg font-light text-white md:text-xl">
      ...
      case 2:
        return (
          <div className="space-y-8">
            <div className="mb-4">
              <h3 className="mb-2 text-lg font-light text-white md:text-xl">
                Where are you noticing challenges most right now?
              </h3>
              <p className="text-sm text-white/50 md:text-base">Select all that apply</p>
            </div>
      ...
      case 3:
        return (
          <div className="space-y-6">
            <div>
              <h3 className="mb-2 text-lg font-light text-white md:text-xl">
                How would you describe your current internal experience?
              </h3>
              <p className="text-sm text-white/50 md:text-base">Your words — no right or wrong</p>
            </div>
            <DarkTextarea
              value={formData.internalExperience}
              onChange={(e) =>
                setFormData((prev) => ({ ...prev, internalExperience: e.target.value }))
              }
      ...
      case 4:
        return (
          <div className="space-y-6">
            <div>
              <h3 className="mb-2 text-lg font-light text-white md:text-xl">
                Which statements feel true for you right now?
              </h3>
              <p className="text-sm text-white/50 md:text-base">Select any that resonate</p>
            </div>
            <div className="space-y-3">
      ...
      case 5:
        return (
          <div className="space-y-6">
            ...
            <div className="pt-4">
              <p className="mb-3 text-sm text-white/50 md:text-base">Optional short note</p>
              <DarkTextarea
      ...
      case 6:
        return (
          <div className="space-y-6">
            <div>
              <h3 className="mb-2 text-lg font-light text-white md:text-xl">
                What do you feel you need more of right now?
              </h3>
              <p className="text-sm text-white/50 md:text-base">Choose intuitively</p>
            </div>
            <div className="space-y-3">
              {NEEDS.map((need) => (
                <SelectionOption
      ...
      case 7:
        return (
          <div className="space-y-6">
            <div>
              <h3 className="mb-2 text-lg font-light text-white md:text-xl">
                If something were to shift, what would you most want to feel?
              </h3>
            </div>
            <DarkTextarea
      ...
      case 8:
        return (
          <div className="space-y-6">
            <div>
              <h3 className="mb-2 text-lg font-light text-white md:text-xl">
                Is there anything you'd like me to be aware of before we speak?
              </h3>
      ...
      case 10:
        return (
          <div className="space-y-6">
            <div>
              <h3 className="mb-2 text-lg font-light text-white md:text-xl">Final check-in</h3>
              <p className="text-[15px] text-white/60 md:text-base">
                When you imagine exploring this process, your body feels more like:
              </p>
            </div>
            <div className="space-y-3">
          ...
          <div className="space-y-10 py-10 text-center">
            <div className="space-y-5">
              <h3 className="text-2xl font-light text-white md:text-3xl">
                Thank you for sharing, {formData.fullName.split(" ")[0]}.
              </h3>
              <p className="mx-auto max-w-[45ch] text-[17px] leading-relaxed text-white/70 md:text-lg">
            ...
            <Button
              ...
              className="rounded-full bg-white px-10 py-6 text-base font-normal text-black transition-all hover:scale-[1.02] hover:bg-white/90 active:scale-[0.98] disabled:opacity-50 md:text-lg"
            >
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent
        hideClose
        className="scrollbar-hide max-h-[90vh] w-[94vw] max-w-[640px] overflow-y-auto rounded-[24px] border border-white/[0.12] bg-black/50 p-0 shadow-[0_24px_80px_rgba(0,0,0,0.5)] backdrop-blur-2xl"
      >
          ...
          {step < 11 && (
            <div className="mb-10 pr-12">
              <div className="mb-4 flex items-center gap-3">
                <span className="text-sm font-normal text-white/70">Step {step} of 10</span>
              </div>
              <div className="h-[6px] overflow-hidden rounded-full bg-white/[0.08]">
                <div
                  ...
                  style={{
                    width: `${(step / 10) * 100}%`,
                    background:
                      "linear-gradient(90deg, rgba(255,255,255,0.5) 0%, rgba(255,255,255,0.7) 100%)",
          ...
          {step < 11 && (
            <div className="mt-10 flex items-center justify-between border-t border-white/[0.06] pt-8">
              ...
              <Button
                ...
                disabled={!canProceed()}
                className={cn(
                  "flex h-auto min-w-[180px] items-center justify-center gap-2 rounded-full px-10 py-5 text-[15px] font-normal transition-all",
                  canProceed()
                    ? "bg-white text-black transition-[background-color,transform] hover:scale-[1.02] hover:bg-white/90 active:scale-[0.98]"
