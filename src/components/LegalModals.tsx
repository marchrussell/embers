    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      ...
      >
        ...
        <div className="px-6 pb-10 pt-16 md:px-10 md:pt-20 lg:px-12">
          ...
          >
            <p>
              Thank you for choosing Embers Studio, operated by Embers Studio Ltd ("Embers Studio",
              "we", "us", or "our"), registered in England and Wales.
            </p>
            ...
            <section className="space-y-4">
              ...
              <p>
                ...
                wellness, breathwork, or somatic practice. Your use of our Services is entirely at
                your own risk.
              </p>
            </section>
            ...
            <section className="space-y-4">
              ...
              <p>
                ...
                described. Refund requests may be made at support@embersstudio.io.
              </p>

              <h4 className="mt-4 font-medium text-[#E6DBC7]/90">Price Changes</h4>
              <p>
                We may modify pricing in the future. You will be notified in advance and may cancel
                before any new pricing takes effect.
              </p>
            </section>
            ...
            <section className="space-y-4">
              ...
              <ul className="list-disc space-y-2 pl-6 text-[#E6DBC7]/80">
                ...
                <li>
                  You are responsible for maintaining access to your email and login credentials.
                </li>
              </ul>
              ...
              <p>
                Under UK consumer law, digital products are non-refundable once access has been
                delivered (including locked pre-sale courses where delivery is defined as receiving
                your course login).
              </p>
              <p>
                Refunds are only provided if the product is faulty, inaccessible due to an issue on
                our end, or not as described.
              </p>
              <p>
                No refunds are offered for change of mind, failure to use the product, or
                misunderstanding of the release date.
              </p>
            </section>
            ...
            <section className="space-y-4">
              ...
              <p>
                This includes in-person sessions, online workshops, breathwork sessions, and
                community events.
              </p>
              ...
              <ul className="list-disc space-y-2 pl-6 text-[#E6DBC7]/80">
                ...
                <li>
                  If an event is cancelled, you will receive a full refund or option to transfer
                  your ticket.
                </li>
              </ul>
            ...
            <section className="space-y-4">
              ...
              <ul className="list-disc space-y-2 pl-6 text-[#E6DBC7]/80">
                ...
                <li>
                  Early-access or founder-rate pricing for digital products does not include
                  additional materials unless noted.
                </li>
              </ul>
            </section>
            ...
            <section className="space-y-4">
              ...
              <p>
                ...
                physical or emotional responses, will practise within your limits, will stop if you
                feel unwell, distressed, or uncomfortable, and have consulted a medical professional
                where appropriate.
              </p>
            </section>
            ...
            <section className="space-y-4">
              ...
              <p>
                ...
                Temporary downtime may occur for maintenance, updates, or technical issues. If a
                significant fault affects paid access, we will investigate and offer appropriate
            ...
            <section className="space-y-4">
              ...
              <p>
                ...
                indirect, incidental, or consequential damages. We make no guarantees of specific
                outcomes or results from any practice or course. Total liability shall not exceed
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      ...
      >
        ...
        <div className="px-6 pb-10 pt-16 md:px-10 md:pt-20 lg:px-12">
          ...
          >
            <p>
              Embers Studio Ltd ("Embers Studio", "we", "us", or "our") is committed to protecting
              your personal information and respecting your privacy rights. This Privacy Policy
              explains how we collect, use, store, and safeguard your personal data when you:
            </p>
            ...
            <p>
              This Policy complies with UK GDPR, EU GDPR, CCPA, and other applicable international
              privacy laws.
            </p>
            ...
            <section className="space-y-4">
              ...
              <ul className="list-disc space-y-2 pl-6 text-[#E6DBC7]/80">
                ...
                <li>
                  Subscription and billing data: handled by Stripe (we do not store full payment
                  details)
                </li>
              ...
              <h3 className="mt-4 font-medium text-[#E6DBC7]">
            ...
            <section className="space-y-4">
              ...
              <p>
                ...
                App are optional and processed under your consent. Do not upload medical records,
                diagnostic information, or sensitive biometric data.
              </p>
            </section>
            ...
            <section className="space-y-4">
              ...
              <p>
                ...
                performance, and support essential site functionality. You may disable non-essential
                cookies at any time.
              </p>
            </section>
            ...
            <section className="space-y-4">
              ...
              <p>
                ...
                Contractual Clauses, UK-US Data Bridge, or equivalent legally approved safeguards.
              </p>
            </section>
            ...
            <section className="space-y-4">
              ...
              <p>
                ...
                withdraw consent, and request data portability. To exercise your rights, email
            ...
            <section className="space-y-4">
              ...
              <p>
                ...
                sale of personal data (we do not sell data), and access your personal information.
                Requests can be emailed to support@embersstudio.io.
              </p>
            </section>
            ...
            <section className="space-y-4">
              ...
              <p>
                ...
                information, and attendance status. Event data is retained only as long as needed
                for event administration and compliance.
              </p>
            </section>
            ...
            <section className="space-y-4">
              ...
              <p>
                ...
                or service changes. For material changes, we will notify you via email or in-app.
              </p>
            </section>
            ...
            <section className="space-y-4">
              ...
              <p>
                If you are in the UK/EU, you may also complain to your local data protection
                authority (e.g., the UK ICO: https://ico.org.uk/).
              </p>
            </section>
          </div>
        </div>
...
export const RefundModal = ({ open, onOpenChange }: LegalModalProps) => {
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent
        hideClose
        className="max-h-[90vh] w-[85vw] max-w-[8xl] overflow-y-auto rounded-xl border border-white/30 bg-black/75 p-0 backdrop-blur-xl"
      >
        <ModalCloseButton onClose={() => onOpenChange(false)} size="md" />
        <div className="px-6 pb-10 pt-20 md:px-12 md:pt-24 lg:px-16">
          <h1
            className="mb-4 text-center font-editorial tracking-[0.01em] text-[#E6DBC7]"
            style={{
              fontSize: "clamp(1.8rem, 2.2vw, 2.4rem)",
          ...
          >
            <p>
              Thank you for choosing to learn and practise with Embers Studio Ltd ("Embers Studio",
              "we", "us" or "our"). This Refund Policy outlines your rights and our responsibilities
