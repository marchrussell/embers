...
export const TermsModal = ({ open, onOpenChange }: LegalModalProps) => (
  ...
  >
    ...
    <p>
      By accessing or using our Services, you agree to these Terms. If you do not agree, please
    ...
    <section className="space-y-4">
      ...
      <p>
        We may modify pricing in the future. You will be notified in advance and may cancel before
        any new pricing takes effect.
      </p>
    </section>
    ...
    <section className="space-y-4">
      <h2 className="font-editorial text-xl font-medium text-[#E6DBC7]">
        3. Digital Products (Courses, Toolkits & Programs)
      </h2>
    ...
    {/* Section 3.1-3.2 */}
    <section className="space-y-4">
      <h3 className="text-lg font-medium text-[#E6DBC7]">3.1 Access to Digital Products</h3>
      <ul className="list-disc space-y-2 pl-6 text-[#E6DBC7]/80">
      ...
      <h3 className="mt-6 text-lg font-medium text-[#E6DBC7]">
        3.2 Refund Policy for Digital Products
      </h3>
      <p>
        Under UK consumer law, digital products are non-refundable once access has been delivered
        (including locked pre-sale courses where delivery is defined as receiving your course
        login).
      </p>
      <p>
        Refunds are only provided if the product is faulty, inaccessible due to an issue on our end,
        or not as described.
      </p>
      <p>
        No refunds are offered for change of mind, failure to use the product, or misunderstanding
        of the release date.
      </p>
    </section>
    ...
    <section className="space-y-4">
      <h2 className="font-editorial text-xl font-medium text-[#E6DBC7]">
        4. Events, Workshops & Live Sessions
      </h2>
      <p>
        This includes in-person sessions, online workshops, breathwork sessions, and community
        events.
      </p>

      <h4 className="mt-4 font-medium text-[#E6DBC7]/90">Refund Policy for Events</h4>
      <ul className="list-disc space-y-2 pl-6 text-[#E6DBC7]/80">
        <li>
          Tickets are non-refundable once purchased unless the event is cancelled by us or
          significantly changed.
        </li>
        <li>You may request transfer to another date (if available) at our discretion.</li>
        <li>
          If an event is cancelled, you will receive a full refund or option to transfer your
          ticket.
        </li>
      </ul>

      <h4 className="mt-4 font-medium text-[#E6DBC7]/90">Event Safety</h4>
      <p>
        By attending any event, you confirm that you are physically and emotionally able to
        participate, will notify the facilitator of any relevant concerns, and take full
        responsibility for your wellbeing throughout the session.
      </p>
    </section>
    ...
    <section className="space-y-4">
      ...
      <ul className="list-disc space-y-2 pl-6 text-[#E6DBC7]/80">
        ...
        <li>
          Early-access or founder-rate pricing for digital products does not include additional
    ...
    <section className="space-y-4">
      ...
      <p>
        By using the Services, you confirm that you understand breathwork may produce physical or
        emotional responses, will practise within your limits, will stop if you feel unwell,
        distressed, or uncomfortable, and have consulted a medical professional where appropriate.
      </p>
    </section>
    ...
    <section className="space-y-4">
      ...
      <p>
        ...
        downtime may occur for maintenance, updates, or technical issues. If a significant fault
        affects paid access, we will investigate and offer appropriate remedies under consumer law.
      </p>
    </section>
    ...
    <section className="space-y-4">
      ...
      <p>
        We may suspend or terminate your account if you violate these Terms or misuse content or AI
        features. If we discontinue the Services, you will receive a pro-rata refund for any unused
        subscription period.
      </p>
    </section>
...
export const PrivacyModal = ({ open, onOpenChange }: LegalModalProps) => (
  ...
  >
    ...
    <p>
      This Policy complies with UK GDPR, EU GDPR, CCPA, and other applicable international privacy
      laws.
    </p>
    ...
    <section className="space-y-4">
      ...
      <h3 className="font-medium text-[#E6DBC7]">a) Information You Provide Directly</h3>
      <ul className="list-disc space-y-2 pl-6 text-[#E6DBC7]/80">
        <li>Account details: name, email address, password</li>
        <li>Digital product purchases: course enrolments, pre-sale details</li>
        <li>
          Subscription and billing data: handled by Stripe (we do not store full payment details)
        </li>
      ...
      <h3 className="mt-4 font-medium text-[#E6DBC7]">b) Information Collected Automatically</h3>
      <ul className="list-disc space-y-2 pl-6 text-[#E6DBC7]/80">
    ...
    <section className="space-y-4">
      ...
      <p>
        These providers operate under data processing agreements, do not retain your data for
    ...
    <section className="space-y-4">
      ...
      <p>
        Our platform is built and hosted on Vercel and Supabase. Data may be transferred and stored
        outside the UK/EU under approved international safeguards.
      </p>
    </section>
    ...
    <section className="space-y-4">
      ...
      <p>
        We do not collect clinical medical information. Any wellness insights you log in the App are
        optional and processed under your consent. Do not upload medical records, diagnostic
        information, or sensitive biometric data.
      </p>
    </section>

    <section className="space-y-4">
      <h2 className="font-editorial text-xl font-medium text-[#E6DBC7]">6. Data Retention</h2>
      <p>Account data is retained while your account is active.</p>
    </section>

    <section className="space-y-4">
      <h2 className="font-editorial text-xl font-medium text-[#E6DBC7]">7. Cookies & Analytics</h2>
      <p>
        We use cookies and analytics tools to understand usage patterns, improve product
        performance, and support essential site functionality. You may disable non-essential cookies
        at any time.
      </p>
    </section>
    ...
    <section className="space-y-4">
      ...
      <p>
        If your data is transferred outside your region, we rely on UK/EU Standard Contractual
        Clauses, UK-US Data Bridge, or equivalent legally approved safeguards.
      </p>
    </section>
    ...
    <section className="space-y-4">
      ...
      <p>
        Our Services are designed for individuals aged 16 and over. We do not knowingly collect
    ...
    <section className="space-y-4">
      ...
      <p>
        When you register for an event or workshop, we process name, email, ticket information, and
        attendance status. Event data is retained only as long as needed for event administration
        and compliance.
      </p>
    </section>
    ...
    <section className="space-y-4">
      ...
      <p>
        We may update this Privacy Policy to reflect new technologies, legal requirements, or
        service changes. For material changes, we will notify you via email or in-app.
      </p>
    </section>
    ...
    <section className="space-y-4">
      ...
      <p>
        For questions, concerns, or requests regarding this Policy or your personal data, contact:
      </p>
      <p className="text-[#E6DBC7]">
        📧{" "}
        <a
      ...
      <p>
        ...
        (e.g., the UK ICO: https://ico.org.uk/).
      </p>
    </section>
  </PolicyModalShell>
);
...
export const RefundModal = ({ open, onOpenChange }: LegalModalProps) => (
  ...
  >
    ...
    <p>
      By making a purchase, you agree to the terms below, which comply with UK consumer protection
      laws.
    </p>
    ...
    <section className="space-y-4">
      ...
      <h3 className="mt-6 font-medium text-[#E6DBC7]">1.2 No Refund for Change of Mind</h3>
      <p>
        Because digital content is delivered (or reserved) instantly and cannot be "returned,"
      ...
      <ul className="list-disc space-y-1 pl-6 text-[#E6DBC7]/80">
        ...
        <li>
          Refunds apply only if the course is not delivered as described, is unavailable, or
          contains a fault.
        </li>
      </ul>
    </section>
    ...
    <section className="space-y-4">
      ...
      <p className="text-[#E6DBC7]/70">
        This includes breathwork workshops, classes, retreats, and any scheduled live group
        experience.
      </p>
      ...
      <ul className="list-disc space-y-1 pl-6 text-[#E6DBC7]/80">
        ...
        <li>
          Transfers to another date may be offered at our discretion if notice is given at least 72
          hours before the event and if space allows.
        </li>
    ...
    <section className="space-y-4">
      ...
      <ul className="list-disc space-y-1 pl-6 text-[#E6DBC7]/80">
        <li>
          You have a 14-day cooling-off period, unless you access digital content immediately.
        </li>
    ...
    <section className="space-y-4">
      ...
      <p className="mt-4 text-[#E6DBC7]/70">This follows UK Consumer Rights Act guidelines.</p>
    </section>
    ...
    <section className="space-y-4">
      ...
      <p className="mt-4 text-[#E6DBC7]/70">We aim to respond within 3–5 business days.</p>
    </section>

    {/* Section 6 */}
    <section className="space-y-4">
      <h2 className="font-editorial text-xl font-medium text-[#E6DBC7]">6. Additional Notes</h2>
      <ul className="list-disc space-y-1 pl-6 text-[#E6DBC7]/80">
        <li>Refunds can only be issued to the original payment method.</li>
        <li>
          We reserve the right to refuse refund claims that fall outside the terms stated above.
        </li>
