  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      ...
      >
        ...
        <DialogHeader>
          <DialogTitle
            className="mb-8 pt-14 text-center font-['PP_Editorial_Old'] text-white sm:mb-10 sm:pt-16 md:mb-14 md:pt-20"
            style={{
        ...
        <div className="grid grid-cols-1 gap-6 px-6 pb-8 sm:gap-8 sm:px-10 sm:pb-12 md:gap-10 md:px-16 md:pb-16 lg:grid-cols-2 xl:grid-cols-3">
          {allTestimonials.map((testimonial, index) => (
            <Card key={index} className="rounded-xl border border-gray-500/50 bg-background">
              <CardContent className="space-y-7 py-10">
                <p className="font-unica text-base font-medium text-white md:text-lg">
                  {testimonial.name}
                </p>
                <p
